...
def handle_query(call):
    if call.data == "my_sub":
        ...
        msg = bot.send_message(
            ...
            "📋 <b>Примеры:</b>\n"
            "• <code>FREE3 3 10</code> — 3 дня подписки, сработает ровно 10 раз\n"
            "• <code>SALE50 50% 25</code> — скидка 50%, сработает 25 раз\n"
            "• <code>VIPMONTH 30</code> — 30 дней, без ограничения по лимиту", 
            parse_mode="HTML"
        )
